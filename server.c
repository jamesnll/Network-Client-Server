...
static void handle_connection(int client_sockfd, struct sockaddr_storage *client_addr, char *buffer);
...
int main(int argc, char *argv[])
{
    ...
    while(!exit_flag)
    {
        ...
        if(dup2(STDOUT_FILENO, sockfd) == -1)
        {
...
/**
 * Handles an established network connection.
 ...
 * connecting from macOS to fedora: connect: Invalid argument
 */
